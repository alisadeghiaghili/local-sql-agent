...
Usage:
    python prompt_based_nlq.py --prompt "How many albums are in the database?"
"""
...
def main():
    ...
    if not args.prompt:
        ...
        print('Example: python prompt_based_nlq.py --prompt "How many albums are in the database?"')
        sys.exit(1)
    ...
    try:
        ...
        logger.error("  4. Run: python prompt_based_nlq.py --prompt \"your question\"")
        sys.exit(1)
