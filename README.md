...
[![Tests](https://img.shields.io/badge/tests-2%2C587-brightgreen)](tests/)
...
| 🧪 | **Test suite** | 2,587 unit + integration tests at 92% coverage, gated at 90%; GitHub Actions CI on Python 3.11–3.13, plus doctests and an offline evaluation gate. |
...
└── tests/                    # 2,587 unit + integration tests
```
...
**2,587 tests at 92% branch coverage**, with the build failing below 90%
...
| **Test suite** | `tests/` — 2,587 unit and integration tests at 92% coverage; GitHub Actions CI across Python 3.11–3.13 |
