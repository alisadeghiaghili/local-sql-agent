...
[![Tests](https://img.shields.io/badge/Tests-2221-green)](tests/)
...
| 🧪 | **Test suite** | 2,221 unit + integration tests; GitHub Actions CI on Python 3.11–3.13. |
...
└── tests/                    # 2,221 unit + integration tests
```
...
| **Test suite** | `tests/` — 2,221 unit and integration tests; GitHub Actions CI across Python 3.11–3.13 |
