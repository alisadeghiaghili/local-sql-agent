...
[![Tests](https://img.shields.io/badge/Tests-2168-green)](tests/)
...
| 🧪 | **Test suite** | 2,168 unit + integration tests; GitHub Actions CI on Python 3.11–3.13. |
...
└── tests/                    # 2,168 unit + integration tests
```
...
| **Test suite** | `tests/` — 2,168 unit and integration tests; GitHub Actions CI across Python 3.11–3.13 |
