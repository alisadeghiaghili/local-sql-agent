BUSINESS_RULES = {
    ...
    Fact.BuyerBroker_ID = Broker.ID

    Examples:

    Top buyer brokers
    Buyer broker ranking
    Buyer broker performance
    ...
    Fact.SellerBroker_ID = Broker.ID

    Examples:

    Top seller brokers
    Seller broker ranking
    Seller broker performance

    ==================================================

    Broker performance must be calculated using:
