...
| | چه چیزی | از کجا | پورت |
|---|---|---|---|
| ترمینال ۱ | بک‌اند FastAPI | **ریشهٔ ریپو** | ۸۰۰۰ |
| ترمینال ۲ | فایل‌سرور استاتیک | `web/` | ۸۰۸۰ |
...
`/health` تنها مسیری است که کلید نمی‌خواهد.
...
- [ ] در مرورگر: زندهٔ API → نشانی بک‌اند → کلید
